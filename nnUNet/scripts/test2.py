...
if __name__ == "__main__":
    origin_seg_dir = r"/data/kfchen/trace_ws/paper_trace_result/nnunet/skelcel_no_tube//origin_seg"
    ...
    work_dir = "/data/kfchen/trace_ws/paper_trace_result/nnunet/skelcel_no_tube/"
